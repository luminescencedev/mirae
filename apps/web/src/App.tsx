          ...
          <Card className="mt-8">
            ...
            <CardContent className="flex flex-col gap-5 pt-0">
              <div className="flex flex-wrap items-center gap-3">
                ...
                <Dialog>
                  ...
                  <DialogContent>
                    <DialogHeader>
                      ...
                      <DialogDescription>
                        Send a brief to a client you already work with.
                      </DialogDescription>
                    </DialogHeader>
                    <Input placeholder="Client name" />
                    <Textarea placeholder="Brief…" rows={3} />
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="start">
                    <DropdownMenuLabel>Commission</DropdownMenuLabel>
                    <DropdownMenuItem>
                      <Icon icon={Edit02Icon} size={16} strokeWidth={1.8} />
                      Edit
                    </DropdownMenuItem>
                    <DropdownMenuItem>
                      <Icon icon={Copy01Icon} size={16} strokeWidth={1.8} />
                      Duplicate
                    </DropdownMenuItem>
                    <DropdownMenuSeparator />
                    <DropdownMenuItem className="text-red-600 focus:bg-red-50 [&_svg]:text-red-600">
                ...
                <Tooltip>
                  ...
                  <TooltipContent>Calm, fast tooltip</TooltipContent>
                </Tooltip>
              </div>
              ...
              <Tabs defaultValue="board">
                ...
                <TabsContent value="board" className="text-sm text-fg-muted">
                  Kanban board view.
                </TabsContent>
                <TabsContent value="list" className="text-sm text-fg-muted">
                  Flat list view.
                </TabsContent>
                <TabsContent value="timeline" className="text-sm text-fg-muted">
                  Timeline view.
                </TabsContent>
              </Tabs>
            </CardContent>
